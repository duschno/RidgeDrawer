...
namespace ImageDrawer
{
	public static class GraphicsExtension
	{
		public static Graphics FillVariableLine(this Graphics g, SolidBrush b, int x1, int y1, int x2, int y2, int w1, int w2)
		{
			...
			g.FillEllipse(new SolidBrush(Color.FromArgb(127, b.Color)), new Rectangle(x1 - w1/2, y1 - w1 / 2, w1, w1));
			g.FillEllipse(new SolidBrush(Color.FromArgb(127, b.Color)), new Rectangle(x2 - w2/2, y2 - w2 / 2, w2, w2));
